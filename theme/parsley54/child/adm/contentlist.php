...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        <th scope="col">ID</th>
        <th scope="col">제목</th>
        <th scope="col">PR-CONTENT</th>
        <th scope="col">보기권한</th>
    ...
    <?php for ($i=0; $row=sql_fetch_array($result); $i++) {
        ...
        // pr-child
        $pr_co_value['co_point'] = 0;
        $pr_co_value['co_filename'] = '미지정';
        $pr_co_value['access_mblv'] = '미지정';
        $sql_pr = " select * from ".PR_CONTENT_EXP." where co_id = '{$row['co_id']}' ";
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td> <?php echo $pr_co_value['co_filename']?> </td>
        <td>lv : <?php echo $pr_co_value['access_mblv']?> </td>
        <td><?php echo number_format($pr_co_value['co_point'])?> point</td>
