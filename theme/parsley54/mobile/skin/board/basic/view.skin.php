...
<article id="bo_v" style="width:<?php echo $width; ?>">
	...
	<div class="bo_v_innr">
	    ...
	    <section id="bo_v_atc">
		    ...
		    <ul class="bo_v_nb">
		        <?php if ($prev_href) { ?><li class="bo_v_prev"><a href="<?php echo $prev_href ?>"><i class="fa fa-angle-left" aria-hidden="true"></i> 이전글 <br><span><?php echo $prev_wr_subject;?></span></a></li><?php } ?>
		        <?php if ($next_href) { ?><li class="bo_v_next"><a href="<?php echo $next_href ?>">다음글<i class="fa fa-angle-right" aria-hidden="true"></i><br><span><?php echo $next_wr_subject;?></span></a></li><?php } ?>
		    </ul>
		    <?php } ?>
		</section>
	</div>
