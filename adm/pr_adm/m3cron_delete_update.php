...
switch($method) {
    case 'before':
        $sql_common = " where substring(datetime, 1, 7) < '$del_date' ";
        break;
    case 'specific':
        $sql_common = " where substring(datetime, 1, 7) = '$del_date' ";
        break;
...
alert('총 '.number_format($total_count).'건 중 '.number_format($total_count - $total_count2).'건 삭제 완료', './m3cron_delete.php');
?>
