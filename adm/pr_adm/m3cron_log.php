...
?>
<tr>
	<td><a href="<?php echo $_SERVER['PHP_SELF']?>?stx=<?php echo $row['name']?>"><?php echo $row['name']?></a></td>
	<td><?php echo $row['datetime']?></td>
	<td class="align_r"><?php echo sprintf("%.3f", $row['runtime']*1000)?> msec</td>
