...
<input type="hidden" name="name" value="<?php echo $prog['name']?>" />
...
<section id="anc_cf_basic">
    ...
    <div class="tbl_frm01 tbl_wrap">
		...
		<tr>
			...
			<td><input type="text" name="descript" value="<?php echo $prog['descript']?>" size="50" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input type="checkbox" name="robot"<?php echo $prog['robot']?" checked":""?> value="1" /> 체크하면 로봇이 접속한 경우만 실행 (실행시간이 길면 사람은 중간에 창을 닫을 수 있음)</td>
		</tr>
		<tr>
			<th scope="row">실행 여부</th>
			<td><input type="checkbox" name="status"<?php echo $prog['status']?" checked":""?> value="1" /> 체크 해제하면 실행 안함</td>
		</tr>
		<tr>
