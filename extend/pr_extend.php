...
define('PR_ADM_URL', G5_THEME_URL.'/child/adm');            //adm을 대체할 폴더
define('PR_ADM_PATH', G5_THEME_PATH.'/child/adm');            //adm을 대체할 폴더
...
define('PR_CONFIG_EXP', G5_TABLE_PREFIX.'config_prexp');    //기본 옵션저장이나 필요한 확장을 담당합니다.. varchar 타입을 저장합니다.
define('PR_NEW_EXP', G5_TABLE_PREFIX.'new_prexp');          //새글을 확장한다.
define('PR_MEMBER_EXP', G5_TABLE_PREFIX.'member_prexp');    //회원테이블을 확장한다.
define('PR_WRITE_EXP', G5_TABLE_PREFIX.'write_prexp');      //게시판을 확장한다.
define('PR_CONTENT_EXP', G5_TABLE_PREFIX.'content_prexp');  //컨텐츠를 확장한다.
define('PR_MEMO_EXP', G5_TABLE_PREFIX.'memo_prexp');        //메모를 확장한다. (알림을 제작한다. / 메모에 첨부(파일)등을 제작예정)
define('PR_SCRAP_EXP', G5_TABLE_PREFIX.'scrap_prexp');      //스크렙을 확장한다. (검색등을 활용)

//srd theme의 기본이 되는 common파일
if ($pr['theme_ch'] == 'true') {
  include_once(PR_THEME_CHILD . '/lib/pr_common_lib.php');
}
 ?>
